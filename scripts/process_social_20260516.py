#!/usr/bin/env python3
"""社会热点数据预处理 2026-05-16：多源交叉验证 + 情绪关键词提取"""

import json
import re
from collections import OrderedDict

INPUT_FILE = "/root/.openclaw/workspace/dushe-daily-data/raw_social_20260516.json"
OUTPUT_PROCESSED = "/root/.openclaw/workspace/dushe-daily-data/data/social_processed_20260516.json"
OUTPUT_EMOTION = "/root/.openclaw/workspace/dushe-daily-data/data/social_emotion_20260516.json"
